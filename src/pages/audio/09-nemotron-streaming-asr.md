...
3. V. Noroozi et al., "Stateful FastConformer with Cache-based Inference for Streaming Automatic Speech Recognition," *ICASSP*, 2024. arXiv:2312.17279.（cache-aware streaming の基盤。look-ahead・キャッシュ機構・hybrid CTC/RNN-T の図はここ）
